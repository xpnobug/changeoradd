...
export class OpenClawApp extends LitElement {
  ...
  // 当前选中的配置区块
  @state() modelConfigActiveSection: "providers" | "agent" | "gateway" | "channels" | "permissions" | "workspace" | "skills" | "cron" = "providers";
  // 通道配置
  ...
  @state() permissionsActiveTab: import("./changeoradd/controllers/model-config").PermissionsTabId = "exec";
  // 工具权限状态
  @state() toolsConfig: import("./changeoradd/controllers/model-config").ToolsConfig | null = null;
  @state() toolsConfigOriginal: import("./changeoradd/controllers/model-config").ToolsConfig | null = null;
  @state() agentToolsConfigs: import("./changeoradd/controllers/model-config").AgentWithTools[] = [];
  @state() agentToolsConfigsOriginal: import("./changeoradd/controllers/model-config").AgentWithTools[] = [];
  @state() toolsSelectedAgent: string | null = null;
  @state() toolsExpanded = false;
  // 会话管理状态 (Agent 设置页)
  @state() agentSessionsLoading = false;
  @state() agentSessionsResult: import("./changeoradd/controllers/model-config").SessionsListResult | null = null;
  @state() agentSessionsError: string | null = null;
  // Agent 身份配置状态 / Agent identity config state
  @state() modelConfigAgentsList: import("./changeoradd/controllers/model-config").AgentIdentityEntry[] = [];
  @state() modelConfigAgentsListOriginal: import("./changeoradd/controllers/model-config").AgentIdentityEntry[] = [];
  @state() modelConfigSelectedAgentId: string | null = null;

  // 工作区文件状态 / Workspace file state
  @state() workspaceFiles: import("./changeoradd/controllers/model-config").WorkspaceFileInfo[] = [];
  @state() workspaceDir = "";
  ...
  @state() addProviderForm: import("./changeoradd/components/providers-content").ProviderFormState = {
    name: "",
    baseUrl: "",
    apiKey: "",
  ...
  @state() skillsConfig: import("./changeoradd/types/skills-config").SkillsConfig | null = null;
  @state() skillsConfigOriginal: import("./changeoradd/types/skills-config").SkillsConfig | null = null;
  @state() skillsConfigFilter = "";
  @state() skillsConfigSourceFilter: import("./changeoradd/types/skills-config").SkillSourceFilter = "all";
  @state() skillsConfigStatusFilter: import("./changeoradd/types/skills-config").SkillStatusFilter = "all";
  @state() skillsConfigExpandedGroups: Set<string> = new Set(["bundled"]);
  @state() skillsConfigSelectedSkill: string | null = null;
  @state() skillsConfigBusySkill: string | null = null;
  @state() skillsConfigMessages: Record<string, import("./changeoradd/types/skills-config").SkillMessage> = {};
  @state() skillsConfigAllowlistMode: "all" | "whitelist" = "all";
  @state() skillsConfigAllowlistDraft: Set<string> = new Set();
  @state() skillsConfigEdits: Record<string, import("./changeoradd/types/skills-config").SkillEditState> = {};
  // 技能编辑器状态 / Skills editor state (Phase 5-6)
  @state() skillsConfigEditor: import("./changeoradd/types/skills-config").SkillEditorState = {
    open: false,
    skillKey: null,
    skillName: null,
    source: null,
  ...
  @state() skillsConfigCreate: import("./changeoradd/types/skills-config").SkillCreateState = {
    open: false,
    name: "",
    source: "workspace",
    template: "",
  ...
  @state() skillsConfigDelete: import("./changeoradd/types/skills-config").SkillDeleteState = {
    open: false,
    skillKey: null,
    skillName: null,
    source: null,
